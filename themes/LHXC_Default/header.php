...
<link href='http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic|Roboto+Condensed:400,700,300' rel='stylesheet' type='text/css'>
...
<div id="header">
     <div id="banner">
            <div id="banner-inner" class="pkg">
             <a href="<?php echo get_option('home'); ?>/"><img src="http://forums.louisvillehardcore.com/styles/LHXC/imageset/site_logo.gif" alt="Louisville Hardcore" class="site-logo"></a>
            </div><!-- /banner-inner .pkg -->

    <nav aria-role="main-navigation" id="global_nav">
       <ul class="nav_slider">
            ...
            <li<?php if (is_home()){ echo " class=\"active\"";}?>><a href="http://www.louisvillehardcore.com/" title="Blog">Blog</a></li>
        </ul>
	</nav>
