...
<span class="event-title-break"></span><br />';
  ...
  $details = '<span class="calnk"><a href="'.$linky.'" style="'.$style.'">' . stripslashes($event->event_title) . '<span style="'.$style.'">' . $header_details . '<div class="clear"></div>' . stripslashes($event->event_desc) . '</span></a></span>';
